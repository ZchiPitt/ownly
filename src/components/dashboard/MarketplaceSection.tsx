...
export function MarketplaceSection() {
  ...
  return (
    <div className="bg-white rounded-[3rem] p-8 soft-shadow border border-[#f5ebe0]/40 space-y-8 overflow-hidden relative">
      <div className="flex items-center justify-between mb-6">
        <div onClick={() => navigate('/marketplace')} className="cursor-pointer group">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-black text-[#4a3f35] tracking-tight group-hover:text-[#d6ccc2] transition-colors">
              Marketplace
            </h2>
          </div>
          <div className="flex items-center gap-2.5 mt-1">
            <span className="w-2 h-2 bg-[#fbc4ab] rounded-full animate-pulse"></span>
            <p className="text-[11px] font-black text-[#8d7b6d]">Give unused items a second life—sell from your inventory, buy from others.</p>
          </div>
        </div>
        <button
