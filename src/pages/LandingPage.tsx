            ...
            <div className="w-full max-w-md space-y-12 animate-in fade-in zoom-in-95 duration-700">
                ...
                <div className="bg-white rounded-[4rem] p-12 soft-shadow border border-[#f5ebe0]/60 space-y-10">
                    ...
                    <div className="space-y-5">
                        ...
                        <Link
                            to="/dashboard"
                            className="w-full bg-white text-[#8d7b6d] font-bold py-6 rounded-[2rem] border-2 border-[#f5ebe0] active:scale-95 transition-all text-base flex items-center justify-center gap-4 soft-shadow hover:bg-gray-50"
                        >
